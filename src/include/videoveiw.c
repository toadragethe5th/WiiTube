...
int voulume=0
int playbuttonhidden=0
int puusebuttonhiden=1
bool muted = false
...
if (muted==false)//)MAKE IT CHECK IF ITS OVER A CEIRTAN THTI IT TURNS TO MEDUIM
{
...
void buttonmanger()
{
    ...
    if()//play button being pressed code thing
    {
    puased==false 
    }
}
